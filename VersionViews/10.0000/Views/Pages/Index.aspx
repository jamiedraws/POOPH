<%@ Page Language="C#" MasterPageFile="~/VersionViews/10.0000/Views/Layouts/InternalLayout.master" Inherits="System.Web.Mvc.ViewPage<OrderPageViewData>" %>
	...
	<div class="view__in main-offer__in section__in">
		<div class="main-offer__group">
			...
			<div class="main-offer__content">
				<div id="video" data-src-iframe="https://player.vimeo.com/video/696261024" data-attr='{ "width" : "392", "height" : "220", "title" : "Commercial", "allow" : "fullscreen" }' class="contain contain--video"></div>

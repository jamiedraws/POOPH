<%@ Page Language="C#" MasterPageFile="~/VersionViews/6.0000/Views/Layouts/InternalLayout.master" Inherits="System.Web.Mvc.ViewPage<OrderPageViewData>" %>
				...
				<div class="main-offer main-offer--offer-product">
					<div class="main-offer__group">
						<div class="main-offer__offer">
							<div class="main-offer__group">
								<div class="main-offer__price">
									<div class="sr">
										<div class="sr__text">Now Only $19.99</div>
									...
									<figure class="bonus-text-product">
										<div class="bonus-text-product__group">
											...
											<div class="bonus-text-product__product">
												<img src="/images/Site6/bonus-product.png" style="mix-blend-mode: lighten;" alt="" width="50" height="117">
											</div>
										</div>
									</figure>
								</div>
						...
						<div class="main-offer__product">
							<img src="/images/Site6/product.png" alt="100% money back guaranteed on this offer of <%= productName %>" width="226" height="411">
						</div>
					</div>
				</div>
			</div>
			<div class="main-offer__content">
				<div id="video" data-src-iframe="https://player.vimeo.com/video/646535169" data-attr='{ "width" : "392", "height" : "220", "title" : "Commercial", "allow" : "fullscreen" }' class="contain contain--video"></div>
			...
			<div class="content__group">
				<div class="content__picture">
					<figure class="figure-picture-text">
						<img src="/images/Site6/in-use.jpg" alt="A person spraying Pooph on the kitchen floor while a dog nearby is watching" loading="lazy" width="473" height="380">
				...
				<div class="content__text">
					<div class="features-benefits">
						...
						<ul class="features-benefits__list">
							<li>Instantly dismantles odors on a molecular basis &mdash; so they never return!</li>
							<li>Eliminates odors that invite pets to defecate in the same spot over and over</li>
		...
		<div class="section__block">
			<div class="content__group">
				<figure class="content__figure content__text">
					<img src="/images/Site6/messes.jpg" alt="" loading="lazy" width="313" height="192">
					<figcaption>Messes</figcaption>
				</figure>
				<figure class="content__figure content__text">
					<img src="/images/Site6/toys.jpg" alt="" loading="lazy" width="313" height="192">
					<figcaption>Toys</figcaption>
				</figure>
				<figure class="content__figure content__text">
					<img src="/images/Site6/fur-faces.jpg" alt="" loading="lazy" width="313" height="192">
					<figcaption>Fur & Faces!</figcaption>
				</figure>
			</div>
		</div>
	</div>
...
<section aria-labelledby="pooph-science-title" class="view content content--text-video section">
	...
	<div class="view__in section__in">
		<div class="section__block">
			<div class="content__group">
				<div class="content__text">
					<h2 id="pooph-science-title" class="content__title">Pooph Science</h2>

...
var ElementController = /*#__PURE__*/function () {
  ...
  function ElementController(root) {
    ...
    if (this.root) {
      this.controllers = Array.from(this.root.querySelectorAll("[aria-controls]"));
    }
  ...
  _proto.initializeController = function initializeController(context, controller) {
    ...
    if (!isExpanded) {
      ElementController.removeElementStateByElements(relatedElements);
    }
  }
  /**
  ...
  ElementController.setElementsByContext = function setElementsByContext(context) {
    ...
    context.controllers.forEach(function (controller) {
      var elements = _this.getContainersByControllerIds(context.getIdsByController(controller), controller, context);
  ...
  ElementController.updateControllerStatesByContext = function updateControllerStatesByContext(context, controllerContext) {
    context.controllers.filter(function (controller) {
      ...
      return controller.setAttribute("aria-expanded", "false");
    });
  }
  /**
  ...
  _proto.getIdsByController = function getIdsByController(controller) {
    ...
    return ((_controller$getAttrib = controller.getAttribute("aria-controls")) != null ? _controller$getAttrib : "").split(" ");
  }
  /**
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "../../node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var Shared_ts_components_carousel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Shared/ts/components/carousel */ "../../Shared-International/ts/components/carousel.ts");
/* harmony import */ var Shared_ts_api_carousel_slide_adapters_slide_carousel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Shared/ts/api/carousel/slide/adapters/slide-carousel */ "../../Shared-International/ts/api/carousel/slide/adapters/slide-carousel.ts");
...
/* harmony import */ var Shared_ts_utils_disclosure__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! Shared/ts/utils/disclosure */ "../../Shared-International/ts/utils/disclosure.ts");
...
(0,Shared_ts_observers_intersection__WEBPACK_IMPORTED_MODULE_4__.observer)(".reviews", {
    inRange: function inRange(record) {
        var carousel = new Shared_ts_components_carousel__WEBPACK_IMPORTED_MODULE_2__["default"](new Shared_ts_api_carousel_slide_adapters_slide_carousel__WEBPACK_IMPORTED_MODULE_3__["default"](record));
        carousel.enablePrevNextControls();
    }
});
var disclosure = new Shared_ts_utils_disclosure__WEBPACK_IMPORTED_MODULE_5__["default"]();

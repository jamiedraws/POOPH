...
/* harmony import */ var Shared_ts_utils_element_controller__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! Shared/ts/utils/element-controller */ "../../Shared-International/ts/utils/element-controller.ts");
...
var ExpressCheckout = /*#__PURE__*/function () {
  ...
  ExpressCheckout.processElementControllerByContext = function processElementControllerByContext(context) {
    var elementController = new Shared_ts_utils_element_controller__WEBPACK_IMPORTED_MODULE_13__["default"](context.root);
    elementController.controllers.forEach(function (controller) {
      controller.addEventListener("click", function () {
        elementController.updateElementStatesByController(controller);
      });
    });
  ...
  _proto.addOrderTypeToControllerByElement = function addOrderTypeToControllerByElement(element) {
    ...
    this.addElementIdByOrderType(orderType, element.id);
  }
  /**
...
/* harmony import */ var Shared_ts_utils_validate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Shared/ts/utils/validate */ "../../Shared-International/ts/utils/validate.ts");
...
var ValidateCommon = /*#__PURE__*/function (_Validate) {
  _inheritsLoose(ValidateCommon, _Validate);
  ...
  function ValidateCommon(config) {
    var _config$inputEvents, _config$comboboxEvent;
  ...
  _proto.validateOnSubmit = function validateOnSubmit() {
    ...
    (_this$submit = this.submit) == null ? void 0 : _this$submit.addEventListener("click", function () {
      _this2.validateAllAgainstCommon();

      _this2.setFocusOnInvalidControl();

      _this2.processControlEvents();
    });
  }
  /**
  ...
  _proto.processInputEvents = function processInputEvents() {
    ...
    this.getRequiredInputs().forEach(function (input) {
      _this3.inputEvents.forEach(function (event) {
        input.removeEventListener(event, _this3.validateInputEvent);
        input.addEventListener(event, _this3.validateInputEvent);
      });
    });
  }
  /**
  ...
  _proto.processComboboxEvents = function processComboboxEvents() {
    ...
    this.getRequiredComboboxes().forEach(function (combobox) {
      _this4.comboboxEvents.forEach(function (event) {
        combobox.removeEventListener(event, _this4.validateComboboxEvent);
        combobox.addEventListener(event, _this4.validateComboboxEvent);
      });
    });
  }
  /**
  ...
  _proto.validateControlAgainstCommon = function validateControlAgainstCommon(control) {
    ...
    this.validateControl(control, function (control) {
      return !_this5.errors.some(function (error) {
        var _error$element;

        return ((_error$element = error.element) == null ? void 0 : _error$element.get(0)) === control;
      });
    });
  }
  /**
  ...
  _proto.validateAllAgainstCommon = function validateAllAgainstCommon() {
    ...
    this.validateAll(function (control) {
      return !_this6.errors.some(function (error) {
        var _error$element2;

        return ((_error$element2 = error.element) == null ? void 0 : _error$element2.get(0)) === control;
      });
    });
  }
  /**
  ...
  _createClass(ValidateCommon, [{
    ...
    function get() {
      ...
      errors.forEach(function (error) {
        ...
        if (!(control != null && control.hasAttribute(_this7.attribute))) {
          control == null ? void 0 : control.setAttribute(_this7.attribute, "true");
        }
      });
      return errors;
    }
...
}(Shared_ts_utils_validate__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
var Validate = /*#__PURE__*/function () {
  ...
  function Validate(config) {
    var _config$form, _this$form, _config$namespace, _config$attribute;
    ...
    this.submit = (_this$form = this.form) == null ? void 0 : _this$form.querySelector("[type=\"submit\"]");
  ...
  _proto.getRequiredInputs = function getRequiredInputs() {
    ...
    return this.inputs.filter(function (input) {
      return input.hasAttribute(_this2.attribute);
    });
  }
  /**
  ...
  _proto.getRequiredComboboxes = function getRequiredComboboxes() {
    ...
    return this.comboboxes.filter(function (combobox) {
      return combobox.hasAttribute(_this3.attribute);
    });
  }
  /**
  ...
  _proto.validateComboboxes = function validateComboboxes(predicate) {
    ...
    this.getRequiredComboboxes().forEach(function (combobox) {
      return _this4.validateControl(combobox, predicate);
    });
  }
  /**
  ...
  _proto.validateInputs = function validateInputs(predicate) {
    ...
    this.getRequiredInputs().forEach(function (input) {
      return _this5.validateControl(input, predicate);
    });
  }
  /**
...
/* harmony import */ var Shared_ts_api_validate_validate_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! Shared/ts/api/validate/validate-common */ "../../Shared-International/ts/api/validate/validate-common.ts");
/* harmony import */ var Shared_ts_api_express_checkout_express_checkout__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! Shared/ts/api/express-checkout/express-checkout */ "../../Shared-International/ts/api/express-checkout/express-checkout.ts");
/* harmony import */ var Shared_ts_observers_intersection__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! Shared/ts/observers/intersection */ "../../Shared-International/ts/observers/intersection.ts");
/* harmony import */ var Shared_ts_utils_html__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! Shared/ts/utils/html */ "../../Shared-International/ts/utils/html.ts");
/* harmony import */ var Shared_ts_utils_capture_element__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! Shared/ts/utils/capture-element */ "../../Shared-International/ts/utils/capture-element.ts");
...
var validateCommon = new Shared_ts_api_validate_validate_common__WEBPACK_IMPORTED_MODULE_6__["default"]({
...
var orderReview = document.querySelector("#orderReview");
var billingStreet = document.querySelector("#BillingStreet");
var shippingStreet = document.querySelector("#ShippingStreet");
addEventListener("load", function (event) {
    if (orderReview) {
        orderReview.classList.remove("c-brand--table");
    }
    if (billingStreet) {
        var captureBillingStreet = new Shared_ts_utils_capture_element__WEBPACK_IMPORTED_MODULE_10__["default"](billingStreet);
        captureBillingStreet.subscribe("attributes", function (record) {
            if (record.attributeName === "autocomplete" && billingStreet.autocomplete === "off") {
                billingStreet.setAttribute("autocomplete", "billing address-line1");
            }
        });
    }
    if (shippingStreet) {
        var captureShippingStreet = new Shared_ts_utils_capture_element__WEBPACK_IMPORTED_MODULE_10__["default"](shippingStreet);
        captureShippingStreet.subscribe("attributes", function (record) {
            if (record.attributeName === "autocomplete" && shippingStreet.autocomplete === "off") {
                shippingStreet.setAttribute("autocomplete", "shipping address-line1");
            }
        });
    }
});
addEventListener("ECDrawFormComplete", function (event) {
    return new Shared_ts_api_express_checkout_express_checkout__WEBPACK_IMPORTED_MODULE_7__["default"]();
});
var getModalDialogControllerId = function getModalDialogControllerId(controller) {
...
var getModalDialogControllerTitle = function getModalDialogControllerTitle(controller) {
...
var getModalDialogControllerSource = function getModalDialogControllerSource(controller) {
    var _controller$getAttrib;
...
var getModalDialogControllerActor = function getModalDialogControllerActor(controller) {
    var actor = controller.getAttribute("data-modal-dialog-actor");
    if (!actor) {
        console.error({
...
var createModalDialogIframeContainerFragment = function createModalDialogIframeContainerFragment(id, title, source) {
    return (0,Shared_ts_utils_html__WEBPACK_IMPORTED_MODULE_9__.renderTemplate)("\n        <section id=\"" + id + "\" aria-label=\"" + title + "\" class=\"view section\">\n            <div class=\"view__in section__in\">\n                <div class=\"defer modal-dialog__iframe\">\n                    <iframe src=\"" + source + "\" title=\"" + title + "\" tabindex=\"0\"></iframe>\n                </div>\n            </div>\n        </section>\n    ");
};
var processModalDialogIframeByController = function processModalDialogIframeByController(controller, controllerContainerMap) {
    if (!controllerContainerMap.has(controller)) {
        var id = getModalDialogControllerId(controller);
        var title = getModalDialogControllerTitle(controller);
        var source = getModalDialogControllerSource(controller);
        if (id && title && source) {
            var _container$getAttribu;
            var fragment = createModalDialogIframeContainerFragment(id, title, source);
...
(0,Shared_ts_observers_intersection__WEBPACK_IMPORTED_MODULE_8__.observer)("[data-modal-dialog-iframe][data-modal-dialog-actor=open]", {
    inRange: function inRange(controller) {
        var controllerContainerMap = new WeakMap();
        controller.addEventListener("click", function (event) {
            event.preventDefault();
            processModalDialogIframeByController(controller, controllerContainerMap);
        });
    }
});
